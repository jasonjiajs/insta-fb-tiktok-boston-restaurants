...
# Display a large and bolded greeting at the top of the page
...
num_followers = st.number_input("Number of Followers", value=default_followers)
...
st.text("Let's see how you compare to other restaurants in the Boston Metropolitan Area")
...
file = st.file_uploader("Upload a file with last 6 months of views, comments and like on Instagram, Facebook and Tiktok")
